...
ПРАВИЛО 3 — храповик. 🕳 (не снято) и ⚠ (снято, но расходится) считаются
            порознь и могут только убывать. Они закрываются разным: 🕳 —
            замером, ⚠ — правкой. Смешать их значило бы спрятать известное
            расхождение под видом незнания.
