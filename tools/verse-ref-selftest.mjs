...
const cases = [
  ...
  /* ЗКН-Н079 (расширение) — книги ИЗ ОДНОГО РАЗДЕЛА: точки в ref нет вовсе, номер
   * стоит после пробела. Раньше матч не находил стих даже по верному адресу, и
   * Ишопанишад / Нектар наставлений / Кришна-сандарбха открывались главой. */
  ["односегментный ref «НН 1» -> стих", resolveVerseRef([{ ref: "НН 1" }, { ref: "НН 2" }], "1"), "НН 1"],
  ["слово вместо номера «ИШО invocation»", resolveVerseRef([{ ref: "ИШО 1" }, { ref: "ИШО invocation" }], "invocation"), "ИШО invocation"],
  ["дефис в названии «Кришна-сандарбха 28»", resolveVerseRef([{ ref: "Кришна-сандарбха 28" }], "28"), "Кришна-сандарбха 28"],
  ["ведущий ноль в односегментном ref", resolveVerseRef([{ ref: "НН 7" }], "07"), "НН 7"],
  ["односегментный: чужой номер не притягивается", resolveVerseRef([{ ref: "НН 1" }, { ref: "НН 11" }], "11"), "НН 11"],
];
