...
function Toast({ msg }: { msg: string | null }) {
  if (!msg) return null;
  return (
    <div style={{ position: "fixed", left: "50%", bottom: "calc(40px + env(safe-area-inset-bottom,0px))", transform: "translateX(-50%)", zIndex: 90, maxWidth: 360, padding: "11px 18px", borderRadius: 999, background: INK, color: "#fff", fontFamily: "var(--font-text)", fontSize: "var(--text-subhead)", fontWeight: 500, boxShadow: "0 8px 24px rgba(0,0,0,.22)", textAlign: "center" }}>{msg}</div>
  );
}
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 36, padding: "26px 20px 12px" }}>
      ...
      <section>
        ...
        <p style={{ margin: 0, fontSize: "var(--text-body)", lineHeight: 1.6, color: INK }}>
      ...
      <section>
        ...
        <p style={{ margin: "0 0 14px", fontSize: "var(--text-callout)", lineHeight: 1.58, color: INK }}>
          Перед вами «Бхагавад-гита как она есть» Его Божественной Милости Абхай Чаранаравинда Бхактиведанты Свами Прабхупады — с оригинальным санскритом, транслитерацией, пословным и литературным переводом и развёрнутыми комментариями.
        </p>
        <div>
          <KeyVal k="Автор" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 36, padding: "26px 20px 12px" }}>
      ...
      <section>
        ...
        <p style={{ margin: "0 0 14px", fontSize: "var(--text-callout)", lineHeight: 1.58, color: INK }}>
          Перед вами «Шри Чайтанья-чаритамрита» с переводом и развёрнутыми комментариями Его Божественной Милости Абхай Чаранаравинда Бхактиведанты Свами Шрилы Прабхупады — с оригиналом, транслитерацией, пословным и литературным переводом и подробными пояснениями.
        </p>
        <div>
          <KeyVal k="Перевод и комментарии" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
          <KeyVal k="Издатель" v="The Bhaktivedanta Book Trust" />
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 34, padding: "28px 20px 12px" }}>
      <header>
        ...
        <div style={{ marginTop: 8, fontSize: "var(--text-subhead)", lineHeight: 1.45, color: INK2 }}>
      ...
      <section>
        ...
        <p style={{ margin: "12px 0 0", fontSize: "var(--text-subhead)", lineHeight: 1.55, color: INK3 }}>
      ...
      <section>
        ...
        <div>
          ...
          <KeyVal k="Герой книги" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
...
function Review({ text, name, role, last }: { text: string; name: string; role: string; last?: boolean }) {
  return (
    <div style={{ padding: "20px 0", borderBottom: last ? "none" : `0.5px solid ${LINE}` }}>
      ...
      <p style={{ margin: "2px 0 0", fontSize: "var(--text-body)", lineHeight: 1.55, color: INK }}>{text}</p>
      <div style={{ marginTop: 12 }}>
        <div style={{ fontSize: "var(--text-subhead)", fontWeight: 700, color: INK }}>{name}</div>
...
function Reviews() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 34, padding: "26px 20px 12px" }}>
      ...
      <p style={{ margin: 0, fontSize: "var(--text-caption)", lineHeight: 1.5, color: INK3 }}>
      ...
      <section>
        ...
        <div>
          <DefRow
            ...
            desc="Авторитетный источник о жизни и учении Гауранга Махапрабху; продолжает «Чайтанья-бхагавату», подробно раскрывая поздний период Его игр." />
          <DefRow
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 36, padding: "26px 20px 12px" }}>
      ...
      <section>
        <SectionTitle>Это издание</SectionTitle>
        <p style={{ margin: "0 0 14px", fontSize: "var(--text-callout)", lineHeight: 1.58, color: INK }}>
          Перед вами «Шримад-Бхагаватам» с переводом и развёрнутыми комментариями Его Божественной Милости Абхай Чаранаравинда Бхактиведанты Свами Шрилы Прабхупады — с оригинальным санскритом, транслитерацией, пословным и литературным переводом и подробными пояснениями.
        </p>
        <div>
          <KeyVal k="Перевод и комментарии" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
          <KeyVal k="Издатель" v="The Bhaktivedanta Book Trust" />
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 36, padding: "26px 20px 12px" }}>
      ...
      <section>
        ...
        <div>
          ...
          <KeyVal k="Автор изложения" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
      ...
      <section>
        ...
        <div>
          <KeyVal k="Изложение и комментарии" v="А. Ч. Бхактиведанта Свами Шрила Прабхупада" />
          <KeyVal k="Издатель" v="The Bhaktivedanta Book Trust" />
...
const BOOK_REVIEWS: Record<string, ReviewsData> = {
  ...
  "siksastaka": {
    intro: "«Шикшаштака» — восемь стихов, единственное произведение, написанное Самим Гаурангой Махапрабху.",
  ...
  "sanmodana-bhashya": {
    intro: "«Санмодана-бхашья» — комментарий Шрилы Бхактивиноды Тхакура к «Шикшаштаке» Гауранги Махапрабху.",
  ...
  "harinama-cintamani": {
    intro: "«Харинама-чинтамани» — наставления о святом имени в форме бесед Гауранги Махапрабху и Шрилы Харидаса Тхакура.",
  ...
  "caitanya-siksamrta": {
    intro: "«Чайтанья-шикшамрита» — систематическое изложение учения Гауранги Махапрабху Шрилой Бхактивинодой Тхакуром.",
  ...
  "jagannatha-vallabha-nataka": {
    intro: "«Джаганнатха-валлабха-натака» — драма Шри Рамананды Рая, близкого спутника Гауранги Махапрабху.",
  ...
  "navadvipa-dhama-mahatmya": {
    intro: "«Навадвипа-дхама-махатмья» — описание славы Навадвипы, земли явления Гауранги Махапрабху, Шрилой Бхактивинодой Тхакуром.",
      ...
      <section>
        ...
        <div>
          ...
          <DefRow
            ...
            desc="Рупа Госвами по указанию Шри Кришна Чайтаньи Махапрабху изложил науку расы — вечных взаимоотношений души с Богом." />
          <DefRow
    ...
    <div style={{ position: "fixed", top: 0, bottom: 0, left: 0, right: 0, margin: "0 auto", width: "100%", maxWidth: 480, zIndex: 70, display: "flex", flexDirection: "column", background: PAPER }}>
      <header style={{ flexShrink: 0, height: 56, display: "flex", alignItems: "center", gap: 4, padding: "0 6px", background: PAPER, borderBottom: `0.5px solid ${collapsed ? LINE : "transparent"}`, transition: "border-color .2s", zIndex: 2 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, textAlign: "left", paddingLeft: 4, opacity: collapsed ? 1 : 0, transform: collapsed ? "none" : "translateY(3px)", transition: "opacity .2s, transform .2s" }}>
          <div style={{ fontSize: "var(--text-subhead)", fontWeight: 700, letterSpacing: "-0.01em", color: INK, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{renderTitle(chapter.title_ru)}</div>
      ...
      <div data-pdf-block style={{ margin: "8px 0 4px" }}>
        ...
        <ol style={{ margin: 0, padding: 0, listStyle: "none" }}>
          {chapters.map((c) => {
            ...
            return (
              <li key={c.id} style={{ display: "flex", alignItems: "baseline", gap: 12, padding: "7px 0", borderBottom: `0.5px solid ${LINE}` }}>
                <span style={{ width: 22, flexShrink: 0, textAlign: "center", fontSize: "var(--text-subhead)", fontWeight: 700, color: GOLDT }}>{showNum ? c.number : "◆"}</span>
                <span style={{ flex: 1, fontSize: "var(--text-subhead)", color: INK }}>{c.title_ru}</span>
              </li>
            );
          })}
        </ol>
    ...
    <div style={{ position: "fixed", top: 0, bottom: 0, left: 0, right: 0, margin: "0 auto", width: "100%", maxWidth: 480, zIndex: 70, display: "flex", flexDirection: "column", background: PAPER }}>
      <header style={{ flexShrink: 0, height: 56, display: "flex", alignItems: "center", gap: 4, padding: "0 6px", background: PAPER, borderBottom: `0.5px solid ${collapsed ? LINE : "transparent"}`, transition: "border-color .2s", zIndex: 2 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, textAlign: "center", opacity: collapsed ? 1 : 0, transform: collapsed ? "none" : "translateY(3px)", transition: "opacity .2s, transform .2s" }}>
          <div style={{ fontSize: "var(--text-subhead)", fontWeight: 700, letterSpacing: "-0.01em", color: INK, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", padding: "0 4px" }}>{renderTitle(chapter.title_ru)}</div>
