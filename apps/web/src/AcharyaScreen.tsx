  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 6 }}>
        ...
        <h1 style={{ margin: "3px 0 0", fontFamily: "var(--font-display)", fontSize: "var(--text-title1)", fontWeight: 800, letterSpacing: "var(--ls-title1)", color: "var(--color-label)" }}>{K ? "Шри Кришна" : "Шри Гауранга"}</h1>
