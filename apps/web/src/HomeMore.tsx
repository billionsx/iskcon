                ...
                <a href={it.url} target="_blank" rel="noopener noreferrer"
                  ...
                  <span style={{ minWidth: 0, flex: 1 }}>
                    <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {it.badge && (
                        <span style={{ flexShrink: 0, padding: "2px 7px", borderRadius: 999, background: `color-mix(in srgb, ${GOLD} 16%, transparent)`, fontFamily: "var(--font-text)", fontSize: "var(--text-caption2)", fontWeight: 700, letterSpacing: "0.4px", textTransform: "uppercase", color: GOLD }}>{it.badge}</span>
                      )}
                    </span>
...
/* Новости ИСККОН переехали в ленту Даршана (/darshan/news) как отдельный тип
   контента: статьи агентств парсятся, переводятся на русский и живут в самой
   ленте — вместо кураторского списка внешних ссылок. Раздел «Новости» из вкладок
   ИСККОН удалён (13.07.2026). */
