...
const EDUCATION: MoreGroup[] = [
  { group: "Прибежище и пранама-мантра", items: [
    { t: "Бхакта-программа в ближайшем центре", d: "Первый шаг — живая община: регулярные программы, наставник, основы садханы. Найдите храм во вкладке «Центры» и придите на воскресную программу", url: "https://centres.iskcon.org/" },
  ...
  { group: "Углублённое изучение", items: [
    ...
    { t: "Ведабейс на русском", d: "Все книги Шрилы Прабхупады с пословным переводом и комментариями — фундамент любого курса", url: "https://vedabase.io/ru/" },
  ]},
];
