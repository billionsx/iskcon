                ...
                <a href={it.url} target="_blank" rel="noopener noreferrer"
                  ...
                  <span style={{ minWidth: 0, flex: 1 }}>
                    <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {it.badge && (
                        <span className="t-kicker2" style={{ flexShrink: 0, padding: "2px 7px", borderRadius: 999, background: `color-mix(in srgb, ${GOLD} 16%, transparent)`, color: GOLD }}>{it.badge}</span>
                      )}
                    </span>
...
function Head({ eyebrow, title, sub }: { eyebrow: string; title: string; sub: string }) {
  return (
    <div style={{ padding: "20px 0 0" }}>
      <div className="t-kicker2" style={{ color: GOLD }}>{eyebrow}</div>
