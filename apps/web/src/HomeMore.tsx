...
const MEDIA: MoreGroup[] = [
  { group: "Прямые трансляции", items: [
    { t: "Mayapur TV", d: "Круглосуточные трансляции из храма Шри Маяпур-чандродая-мандира: мангала-арати, киртаны, лекции, фестивали", url: "https://www.mayapur.tv/", badge: "Live" },
    { t: "ISKCON Vrindavan Live", d: "Прямой эфир из храма Кришна-Баларама-мандир во Вриндаване", url: "https://iskconvrindavan.com/live/", badge: "Live" },
  ]},
  { group: "Фильмы о движении", items: [
    { t: "Hare Krishna! The Mantra, the Movement and the Swami Who Started It All", d: "Документальный фильм (2017) о Шриле Прабхупаде и рождении Движения — премии кинофестивалей, прокат по всему миру", url: "https://www.harekrishnathefilm.com/" },
    { t: "Your Ever Well-Wisher", d: "Классический фильм ITV о жизни Шрилы Прабхупады по «Прабхупада-лиламрите»", url: "https://prabhupada.io/films" },
    { t: "Acharya", d: "Полнометражный анимационно-документальный фильм к 125-летию Шрилы Прабхупады", url: "https://acharyafilm.com/" },
  ]},
  { group: "Видеоканалы", items: [
    { t: "ISKCON News", d: "Официальный новостной видеоканал общества: репортажи, интервью, события по всему миру", url: "https://www.youtube.com/@ISKCONNews" },
    { t: "Prabhupada — оцифрованный архив", d: "Bhaktivedanta Archives: оригинальные киноплёнки, лекции и киртаны Шрилы Прабхупады", url: "https://prabhupada.io/" },
    { t: "ISKCON Desire Tree", d: "Крупнейшая медиатека движения: лекции, киртаны, фильмы, детский контент", url: "https://iskcondesiretree.com/" },
  ]},
  { group: "Радио и аудио", items: [
    { t: "24 Hour Kirtan Radio", d: "Непрерывный киртан из Шри Вриндавана-дхамы — круглосуточный эфир святого имени", url: "https://www.24hourkirtan.fm/", badge: "24/7" },
    { t: "ISKCON Desire Tree Radio", d: "Радиопотоки лекций и бхаджанов на разных языках", url: "https://audio.iskcondesiretree.com/" },
  ]},
];
...
const EDUCATION: MoreGroup[] = [
  { group: "Колледжи и институты", items: [
    { t: "Bhaktivedanta College", d: "Колледж ИСККОН в Радхадеше (Бельгия): бакалавриат по вайшнавскому богословию, очно и онлайн", url: "https://www.bhaktivedantacollege.com/" },
    { t: "Mayapur Institute", d: "Институт высшего образования и обучения в Шридхаме Маяпуре: шастрические степени, семинары, языковые программы", url: "https://mayapurinstitute.org/" },
    { t: "Vrindavan Institute for Higher Education (VIHE)", d: "Институт во Вриндаване: углублённое изучение писаний и санскрита у старших преданных", url: "https://vihe.org/" },
    { t: "Bhaktivedanta Vidyapitha", d: "Исследовательский центр изучения «Шримад-Бхагаватам» при ISKCON Govardhan Eco Village", url: "https://vidyapitha.in/" },
  ]},
  { group: "Систематическое изучение", items: [
    ...
    { t: "Курс ученика (ISKCON Disciple Course)", d: "Обязательный курс GBC для получающих инициацию: гуру-таттва, отношения учителя и ученика, стандарты общества", url: "https://gbc.iskcon.org/" },
  ]},
  { group: "Онлайн-обучение", items: [
    { t: "ISKCON Education Ministry", d: "Министерство образования ИСККОН: стандарты, программы, аккредитация учебных заведений движения", url: "https://education.iskcon.org/" },
    { t: "Vedabase — самостоятельное изучение", d: "Все книги Шрилы Прабхупады с поиском, пословным переводом и комментариями — основа любого курса", url: "https://vedabase.io/ru/" },
    { t: "Bhakti Courses (ISKCON Desire Tree)", d: "Онлайн-курсы по книгам Прабхупады на нескольких языках, включая русский", url: "https://bhakticourses.com/" },
  ]},
];
