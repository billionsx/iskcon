...
const FORMS = [
  { t: "Мантра", d: "Звуковая форма Кришны и Шримати Радхарани (Харе). Повторение мантры Харе Кришна (тихо — джапа, громко — киртан) помогает очистить ум и сердце, мгновенно соединяя вас с Богом и позволяя ощущать Его присутствие.", to: "/bhajans" },
  ...
  { t: "Божества", d: "Проявленные формы Кришны и Шримати Радхарани (Харе) в этом мире неотличны от их вечных духовных форм, что позволяет преданным служить Им непосредственно.", to: "/dhama" },
  ...
  { t: "Садху", d: "Святые, хранящие в своих сердцах Кришну и Шримати Радхарани (Харе), являются духовными наставниками и учителями, источниками вдохновения, показывающими живой пример преданности, служения и любви.", to: "/lichnosti" },
  ...
  return (
    <div style={{ fontFamily: "var(--font-text)" }}>
      ...
      <Figure src="/media/prabhupada-color.webp" ratio="4 / 3" pos="center 22%"
        caption="Ачарья-основатель ИСККОН — Его Божественная Милость Абхай Чаранаравинда Бхактиведанта Свами Шрила Прабхупада" />
...
<SectionHead eyebrow="Ачарья-основатель" title="Шрила Прабхупада" subtitle="Выдающийся духовный учитель, принёсший сознание Кришны в западный мир и заложивший основы глобального вайшнавского возрождения. Его жизнь с любовью описана в семитомной «Шрила Прабхупада-лиламрите», читаемой по всему миру." />
      ...
      <Section id="hsec-next">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <NavCard mark={<MaskMark src="/prabhupada.svg" size={44} />} title="Герои" subtitle="Господь, аватары и спутники" onClick={() => onOpenPath?.("/lichnosti")} />
