      ...
      {d && (
        <div style={{ padding: "0 20px 24px" }}>
          ...
          <div style={{ marginTop: 16 }}>
            {d.body.map((p, i) => (
              <p key={i} style={{ margin: i ? "12px 0 0" : 0, fontFamily: "var(--font-text)", fontSize: "var(--text-subhead)", lineHeight: 1.62, letterSpacing: "-0.01em", color: "var(--color-label)" }}>{p}</p>
            ))}
          </div>
...
const STRUCTURE = [
  { t: "Ачарья-основатель", d: "Его Божественная Милость Абхай Чаранаравинда Бхактиведанта Свами Шрила Прабхупада — вечный духовный глава ИСККОН. Его книги, наставления и стандарты — высший авторитет общества для всех поколений (документ SPPM, 2013)." },
