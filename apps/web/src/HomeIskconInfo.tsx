...
const STRUCTURE = [
  { t: "Ачарья-основатель", d: "Его Божественная Милость А. Ч. Бхактиведанта Свами Шрила Прабхупада — вечный духовный глава ИСККОН. Его книги, наставления и стандарты — высший авторитет общества для всех поколений (документ SPPM, 2013)." },
