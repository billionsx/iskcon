...
const TOOLS: Tool[] = [
  ...
  { id: "katha", title: "Катха", subtitle: "Бхагавата-катха рассказчиков традиции", keywords: "катха лекции бхагавата шримад-бхагаватам слушать аудио радха говинда госвами махарадж гопи-гита аджамила", href: "/katha" },
];
