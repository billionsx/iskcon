...
export function HomeScreen({ ui }: { ui: UI }) {
  return (
    <Scr>
      <div className="amx-top"><div className="amx-h1">Home</div><Ava /></div>
...
export function NewScreen({ ui }: { ui: UI }) {
  return (
    <Scr>
      <div className="amx-top"><div className="amx-h1">New</div><Ava /></div>
...
export function RadioScreen({ ui }: { ui: UI }) {
  return (
    <Scr>
      <div className="amx-top"><div className="amx-h1">Radio</div><Ava /></div>
...
export function SearchTab({ ui }: { ui: UI }) {
  return (
    <Scr>
      <div className="amx-top"><div className="amx-h1">Search</div><Ava /></div>
