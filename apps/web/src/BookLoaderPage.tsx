...
const sectionLabel: CSSProperties = { fontSize: "var(--text-caption2)", fontWeight: 600, letterSpacing: "var(--ls-caption2)", textTransform: "uppercase", color: "var(--color-label-2)", margin: "0 0 10px" };
