 ...
 * v9 — доставка телефонной рамки 393 в /music (старый CSS в кэшах рвал вёрстку).
 * v8 — доставка фикса мобильного краш-лупа «A problem repeatedly occurred»:
 * safeReload теперь на всех путях reload, HEAL не роняет загрузку и не
 * зацикливается на iOS с эфемерным storage. Правка живёт в бандле, поэтому до
 * застрявшего старого SW доедет только сменой байтов этого файла (ЗКН-Ф021). */
const CACHE = "iol-v9";
