...
Прежний домен **не выбрасывается**: он остаётся привязанным к воркеру и 301-ит
на новый. Ссылки, QR-коды и уже опубликованные метаданные Internet Archive ведут
на gaurangers.com навсегда (ЗКН-Н023, правило 6) — они обязаны продолжать работать.
