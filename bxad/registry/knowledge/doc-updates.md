...
- Frontier model providers can use the new protocol to vend a Swift package to bridge their powerful cloud-hosted models to the Foundation Models API.
- Foundation Models now supports image input as well as text, which you can learn to use by reading .
- Use an to send the image to the model along with your prompt.
- Learn how to measure and improve your prompts by reading and develop a strategy about to optimize token use.
- Core AI also vends your custom AI models in a format that Foundation Models can use natively, so once adapted to Core AI, your models can interact with the same Foundation Models code you write when working with Apple’s own built-in models.
- Read to see how best to specialize your AI model, either in advance by , or cached on first use within the app.
- Read to learn how you can build a strategy to evaluate your use of models within your app.
- Good evaluations require time spent as well as .
- Learn to use reorderable containers in your SwiftUI apps by reading .
